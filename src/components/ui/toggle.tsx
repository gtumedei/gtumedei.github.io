...
export const toggle = tv({
  slots: {
    ...
    control:
      "shrink-0 h-5 w-8 flex justify-center items-center rounded-full border border-on-base/20 data-[state=checked]:bg-accent data-[state=indeterminate]:bg-accent data-[state=checked]:border-transparent data-[state=indeterminate]:border-transparent data-disabled:bg-on-base/20! data-disabled:border-transparent data-focus:ring ring-on-base/10 data-[state=checked]:ring-accent/20 transition-all",
    thumb:
