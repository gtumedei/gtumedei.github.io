...
export const button = tv(
  {
    ...
    variants: {
      variant: {
        ...
        raised:
          "bg-base-100 dark:bg-base-200 hover:bg-base-200 rounded-full! border border-on-base/10 hover:border-on-base/20 shadow-md shadow-black/3 focus-visible:ring-on-base/10",
      },
      theme: {
        neutral: "",
        accent: "",
