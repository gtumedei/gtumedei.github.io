...
export const button = tv({
  base: "inline-flex justify-center items-center gap-2 border font-medium transition-all outline-none focus-visible:ring [&:not(:disabled,[data-disabled])]:cursor-pointer [&:where(:disabled,[data-disabled])]:shadow-none!",
  defaultVariants: { variant: "solid", theme: "neutral", size: "md", shape: "rounded" },
  variants: {
    variant: {
      solid:
        "shadow-xs shadow-black/3 [&:where(:disabled,[data-disabled])]:bg-neutral/20! [&:where(:disabled,[data-disabled])]:text-on-base/50! [&:where(:disabled,[data-disabled])]:border-on-base/5!",
      subtle:
    ...
    size: {
      xs: "h-8 text-sm px-2 rounded-lg",
      sm: "h-9 text-sm px-3 rounded-lg",
      md: "h-10 text-sm px-4 rounded-[10px]",
      lg: "h-11 text-base px-5 rounded-[10px]",
      xl: "h-12 text-lg px-6 rounded-[10px]",
    },
    shape: {
      rectangle: "",
  ...
  compoundVariants: [
    {
      ...
      theme: "neutral",
      class:
        "bg-neutral text-on-neutral border-on-neutral/10 hover:bg-neutral/90 active:bg-neutral/80 focus-visible:border-transparent focus-visible:ring-neutral/20",
    },
    {
      variant: "solid",
      theme: "accent",
      class:
        "bg-accent text-on-accent border-on-accent/10 hover:bg-accent/90 active:bg-accent/80 focus-visible:border-transparent focus-visible:ring-accent/20",
    },
    {
      variant: "solid",
      theme: "error",
      class:
        "bg-error text-on-error border-on-error/10 hover:bg-error/90 active:bg-error/80 focus-visible:border-transparent focus-visible:ring-error/20",
    },
  ],
})
